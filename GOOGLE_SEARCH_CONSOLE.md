...
2. `frontend/` 폴더에 업로드
3. `https://amazon-reach.com/google[코드].html` 접속 가능한지 확인
...
2. **새 사이트맵 추가** 입력란에 입력:
```
https://amazon-reach.com/sitemap.xml
```
3. **제출** 클릭
...
2. 블로그 URL 입력:
```
https://amazon-reach.com/blog/post-1.html
https://amazon-reach.com/blog/post-2.html
https://amazon-reach.com/blog/post-3.html
```
3. **색인 생성 요청** 클릭
4. 각 블로그 포스트마다 반복
...
```xml
<url>
    <loc>https://amazon-reach.com/blog/post-1.html</loc>
...
User-agent: *
Allow: /
Sitemap: https://amazon-reach.com/sitemap.xml
```
